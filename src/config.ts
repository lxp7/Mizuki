...
export const siteConfig: SiteConfig = {
	title: "LXP",
	subtitle: "凉皮好吃",
	siteURL: "https://lxp7.cn/", // 请替换为你的站点URL，以斜杠结尾
	...
	bilibili: {
		vmid: "70974861", // 在此处设置你的Bilibili用户ID (vmid)，例如 "1129280784"
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/乔尼2.jpg", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "凉小皮",
	bio: "平平淡淡的生活",
	typewriter: {
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		"https://www.bilibili.uno/api?server=netease&type=playlist&id=170672512&auth=&r=20260303", // Meting API 地址
	id: "170672512", // 歌单ID
...
export const footerConfig: FooterConfig = {
	...
	customHtml: "鲁ICP备2022031798号-1", // HTML格式的自定义页脚信息，例如备案号等，默认留空
